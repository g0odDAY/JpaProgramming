...
public class MappingJoinHibernateTest {
    private static SessionFactory createSessionFactory() {
        Configuration configuration = new Configuration();
        configuration.configure().addAnnotatedClass(BillingDetails.class).addAnnotatedClass(BankAccount.class).addAnnotatedClass(CreditCard.class);
    ...
    public void storeLoadEntities() {
        ...
        try (SessionFactory sessionFactory = createSessionFactory();
            ...
            List<BillingDetails> bills = session.createQuery("select bd from BillingDetails bd", BillingDetails.class).getResultList();
            session.getTransaction().commit();
